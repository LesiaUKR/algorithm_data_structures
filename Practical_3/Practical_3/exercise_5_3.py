...
existing_substring = "Стаття" # Значення на початку файлів, можна ще порівняти з "Література" який майже в кінці двох статтей
fake_substring = "Свій вигаданий рядок тут :)"
...
if __name__ == '__main__':
    ...
    for i, text in enumerate([text1, text2]):
        print(f"\nСтаття №{i+1}")
        results = []
        for pattern in [fake_substring, ]:
            for search_func in [boyer_moore_search, regex_search]:
