# https://www.youtube.com/watch?v=oORZUbz6tJw
# Алгоритм Рабіна-Карпа має асимптотичну складність:
# 1. У найгіршому випадку: O(n×m), де n — довжина основного рядка, а 
# m — довжина підрядка. Це трапляється, коли маємо багато хеш-колізій, 
# і нам потрібно безпосередньо порівнювати багато підрядків
# 2. У середньому випадку та в найкращому випадку: 
# O(n+m). Ця складність враховує обчислення хеш-значень і можливість швидкого порівняння хешів
# На практиці алгоритм часто працює з ефективністю, близькою до лінійної, завдяки рідкісним колізіям хеш-функції
