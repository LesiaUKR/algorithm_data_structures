#  алгоритм Дейкстри буде працювати некоректно для графів з від'ємними вагами ребер
# алгоритм Дейкстри є прикладом жадібного алгоритму
...
# алгоритм Дейкстри - алгоритм пошуку найкоротшого шляху в графі з невід'ємними вагами ребер
...
# показує найкоротші відстані від початкової вершини A до кожної іншої вершини
print(dijkstra(graph, 'A')) # виведе {'A': 0, 'B': 5, 'C': 8, 'D': 7, 'E': 11}


# додамо print_table для відображення таблиці після кожного кроку алгоритму
