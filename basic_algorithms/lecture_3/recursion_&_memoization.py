...
# memo = {} -  не вказувати словник в аргументах функції, бо він буде передається по посиланню
# і при повторному виклику функції memo буде тим самим словником, яким він був при попередньому виклику
# тому краще вказати його значення по замовчуванню memo=None
