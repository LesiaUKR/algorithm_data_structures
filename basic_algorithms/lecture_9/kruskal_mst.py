# Minimum Spanning Tree - Kruskal's Algorithm - мінімальне остовне дерево за алгоритмом Краскала
# Алгоритм Краскала - це різновид жадібного алгоритма побудови мінімального остовного дерева в зваженому графі
# Часова складність алгоритму переважно залежить від швидкості сортування ребер, яка зазвичай 
# O(ElogE) де E— кількість ребер у графі. Сам процес знаходження мінімального 
# остовного дерева має часову складність O(ElogV), де V — кількість вершин.
